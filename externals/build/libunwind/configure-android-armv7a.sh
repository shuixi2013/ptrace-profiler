...
cd ../../libunwind
#autoreconf -i
#./configure CC=~/Library/Android/ndk/r10e/toolchains/arm-linux-androideabi-4.8/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-gcc
#    CPPFLAGS="-I~/Library/Android/ndk/r10e/platforms/android-5/arch-arm/usr/include/"
#    CFLAGS="-march=armv7-a -mthumb -mfpu=vfp -mfloat-abi=softfp -nostdlib"
#    LDFLAGS="-Wl,-rpath-link=~/Library/Android/ndk/r10e/platforms/android-5/arch-arm/usr/lib/ -L~/Library/Android/ndk/r10e/platforms/android-5/arch-arm/usr/lib/"
#    LIBS="-lc -lgcc" -host=arm-linux-androideabi

ANDROID_TOOLCHAIN="~/Library/Android/ndk/r10e/toolchains/arm-linux-androideabi-4.8/prebuilt/darwin-x86_64/bin"
arm_cc="${ANDROID_TOOLCHAIN}/arm-linux-androideabi-gcc"
arm_cpp="${ANDROID_TOOLCHAIN}/arm-linux-androideabi-g++"

includes=(
  "-I~/Library/Android/ndk/r10e/platforms/android-5/arch-arm/usr/include/"
